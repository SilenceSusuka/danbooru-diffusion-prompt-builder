...
import {faEye, faEyeSlash, faClipboard, faThumbsDown, faThumbsUp, faThumbsDown as faThumbsDownRegular, faThumbsUp as faThumbsUpRegular, faLightbulb as faLightbulbOn, faMoon as faLightbulbSlash} from '@fortawesome/free-regular-svg-icons'
import {faCircleMinus, faCirclePlus, faTrash, faBlender as faBlenderRegular} from '@fortawesome/free-solid-svg-icons'
